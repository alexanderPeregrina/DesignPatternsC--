...
// Demonstrates the Visitor design pattern using std::variant and std::visit
// Shows two approaches: using a functor class (AddressPrinter) and using a lambda
// to process different types stored in a variant container
